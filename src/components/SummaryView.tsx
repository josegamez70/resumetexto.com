...
<body>
  <div class="wrap">
    ...
    if (iframe.contentWindow) {
      ...
      // srcdoc es soportado por los navegadores modernos
      iframe.srcdoc = html;
    } else {
      // Fallback muy viejo
    ...
    <div className="max-w-5xl mx-auto p-4 sm:p-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-gray-800 rounded-xl p-4 sm:p-5 border border-gray-700">
          <h2 className="text-xl sm:text-2xl font-bold mb-1">🧩 Mapa conceptual</h2>
          <p className="text-gray-300 mb-4 text-sm sm:text-base">
            <strong>¿Qué es?</strong> Un esquema con secciones que puedes abrir/cerrar
            (desplegables) y subniveles. Útil para estudiar o repasar por bloques.
            <br />
            <strong>Consejo:</strong> usa <em>Desplegar/Colapsar</em>, y descarga el HTML para
            tenerlo igual que aquí.
          </p>
        ...
        {/* Caja Mapa Mental */}
        <div className="bg-gray-800 rounded-xl p-4 sm:p-5 border border-gray-700">
          <h2 className="text-xl sm:text-2xl font-bold mb-1">🧠 Mapa mental (extendido)</h2>
          <p className="text-gray-300 mb-4 text-sm sm:text-base">
            <strong>¿Qué es?</strong> Un árbol que parte del tema central. En ordenador,
            las ramas crecen hacia la derecha; en móvil, los hijos se muestran debajo.
            <br />
            <strong>Color:</strong> “A color” hereda el color de la madre con menos intensidad.
            Las líneas de conexión usan el mismo color de la madre.
          </p>
