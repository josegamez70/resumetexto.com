...
interface PresentationViewProps {
  ...
  summaryTitle: string;
  onMindMap: () => void; // ya no se usa en cabecera, lo dejamos por compat
  onReset: () => void;
}
...
<body class="bg-gray-900 text-white p-4 sm:p-6">
  ...
  <div class="grid grid-cols-1 sm:flex gap-2 mb-4">
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 animate-fadeIn">
      ...
      <div className="flex items-stretch sm:items-center justify-between gap-3 mb-4 sm:mb-6">
        <div>
      ...
      {/* Controles (incluye Descargar HTML) */}
